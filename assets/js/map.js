...
const GenericIcon = L.Icon.extend({
	options: {
		iconSize: [32, 32],
		iconAnchor: [16, 32],
		popupAnchor: [0, -32],
...
const FULL_ICON = new GenericIcon({
	iconUrl: './assets/icons/geo-alt-fill-red.svg',
});
const EMPTY_ICON = new GenericIcon({
	iconUrl: './assets/icons/geo-alt-red.svg',
});
