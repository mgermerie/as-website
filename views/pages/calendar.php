					...
					<form	class="event-panel-registration-form"
						...
						<fieldset	class="form-fieldset register-user
							...
							<span class="form-label-hint cannot-register-label">
								Vous êtes déjà inscrit à cette épreuve en tant
								que participant à une autre date. Vous ne pouvez
								vous inscrire qu'à une seule date pour chaque
								épreuve.
							</span>
							<input	class="button first-color full-button
									...
									value="S'inscrire en tant que participant">
						</fieldset>
						...
						<fieldset	class="form-fieldset register-referee
							...
							<input	class="button first-color
										form-input form-input-submit"
									type="submit"
									name="registerToEventAsReferee"
									value="S'inscrire en tant qu'encadrant">
						</fieldset>
						<fieldset	class="form-fieldset unregister-referee
										event-panel-registration-fieldset">
							<span class="form-label-hint">
								Vous êtes inscrit à cette épreuve
								<span class="registered-as-referee">
							...
							<input	class="button first-color
										form-input form-input-submit"
									type="submit"
									name="unRegisterFromEventAsReferee"
									value="Ne plus encadrer cette épreuve">
						</fieldset>
